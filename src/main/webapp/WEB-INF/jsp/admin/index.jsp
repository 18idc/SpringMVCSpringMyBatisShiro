...
<head>
    ...
    <link href="${ctx}/script/miniui/demo.css" rel="stylesheet" type="text/css" />
    <script src="${ctx}/script/miniui/boot.js" type="text/javascript"></script>
    <style type="text/css">
        body{
    ...
    <div title="center" region="center" style="border:0;" bodyStyle="overflow:hidden;">
        ...
        <div class="mini-splitter" style="width:100%;height:100%;" borderStyle="border:0;">
            <div size="180" maxSize="250" minSize="100" showCollapseButton="true" style="border:0;">
                <!--OutlookMenu-->
                <div id="leftMenu" class="mini-outlookmenu" url="${ctx}/admin/menu/list" onitemselect="onItemSelect"
            ...
            <div showCollapseButton="false" style="border:0;">
                ...
                <div id="mainTabs" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;"
                     plain="false">
                    <div title="首页" url="${ctx}/admin/main.html" ></div>
...
<script type="text/javascript">
    ...
    function onLogoutClick() {
        mini.confirm('确定要退出系统吗？','退出？',function (action) {
            if (action == "ok"){
                window.location='${ctx}/login/logout.html';
            }
        });
    }
